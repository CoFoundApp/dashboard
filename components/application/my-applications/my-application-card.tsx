...
import { GET_MY_APPLICATIONS, WITHDRAW_PROJECT_APPLICATION } from "@/graphql/application"
...
export default function MyApplicationCard({ application }: MyApplicationCardProps) {
    ...
    const statusLabel = applicationStatusLabels[application.status as keyof typeof applicationStatusLabels];
